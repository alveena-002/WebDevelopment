                        ...
                        >
                            ...
                            <SimpleBar className="dropdown-body p-2">
                                ...
                                <Dropdown.Item className="bg-transparent">
                                    <JampackBadge bg="secondary" soft pill className="me-1" >React</JampackBadge>
                                    <JampackBadge bg="secondary" soft pill className="me-1" >Node JS</JampackBadge>
                                    <JampackBadge bg="secondary" soft pill>SCSS</JampackBadge>
                                </Dropdown.Item>
                            ...
                            <Button variant="flush-dark" as={Link} to="/email" className="btn-icon btn-rounded flush-soft-hover">
                                <span className="icon">
                                    <span className=" position-relative">
                                        ...
                                        <JampackBadge bg="primary" soft pill size="sm" className="position-top-end-overflow-1" >4</JampackBadge>
                                    </span>
                                </span>
                            </Button>
                        </Nav.Item>
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        ...
                                                        <div className="notifications-info">
                                                            <JampackBadge bg="success" soft >Collaboration</JampackBadge>
                                            ...
                                            <div className="media">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        ...
                                                        <div className="notifications-info">
                                                            <JampackBadge bg="violet" soft >File Manager</JampackBadge>
                                            ...
                                            <div className="media">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        ...
                                                        <div className="notifications-info">
                                                            <JampackBadge bg="orange" soft >Updates</JampackBadge>
